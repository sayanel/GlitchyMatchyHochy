...
public class Level implements Drawable{
    ...
    public void storeScenePatterns() throws IOException{
        ...
        //Recuperer tous les fichiers et � chaque fois les enregistrer dans l'array
    ...
    public void storeObjectPatterns() throws  IOException{
        //Lire le fichier scene.info pour savoir le nombre de patterns � enregistrer
    ...
    public LevelModule genLevelModule(double position){
        ...
        //trouver al�atoirement un pattern dans l'array de patterns
